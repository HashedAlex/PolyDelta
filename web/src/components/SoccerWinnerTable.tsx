...
interface SoccerWinnerTableProps {
  markets: MarketItem[]
  hideLowOdds: boolean
  league: 'epl' | 'ucl'
}

export function SoccerWinnerTable({ markets, hideLowOdds, league }: SoccerWinnerTableProps) {
    ...
    <section>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-[#e6edf3]">{config.name}</h2>
                ...
                {filteredMarkets.map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Bookie Odds - Show N/A for poly_only markets */}
                      <td className="py-3 px-3 text-center">
                        <span className="text-[#6e7681] text-xs">N/A</span>
                      </td>

                      {/* EV - Show N/A for poly_only markets */}
                      <td className="py-3 px-3 text-center">
                        <span className="text-[#6e7681] text-xs">N/A</span>
                      </td>
