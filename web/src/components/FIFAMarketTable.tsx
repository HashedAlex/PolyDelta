...
interface FIFAMarketTableProps {
  markets: MarketItem[]
  hideLowOdds: boolean
}

export function FIFAMarketTable({ markets, hideLowOdds }: FIFAMarketTableProps) {
    ...
    <section>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-[#e6edf3]">FIFA World Cup 2026 Winner</h2>
                    ...
                    >
                      ...
                      <td className="py-3 px-3">
                        <div className="flex items-center gap-2">
                          <span className="text-lg">{getCountryFlag(item.team_name)}</span>
